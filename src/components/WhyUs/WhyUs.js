...
const WhyUs = () => {
    const whyChooseUs= [
        ...
        {reson:'Experienced teacher ', description:'We give the highest quality at a competitive price in the market.'}, 
        {reson:'Save money ', description:'Most of our teachers are highly experienced and practice with the most recent materials from the previous exam'}, 
